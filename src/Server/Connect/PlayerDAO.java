...
public class PlayerDAO {
    ...
    public static boolean createNewPlayer(int userId, String name, byte gender, int hair) {
        try {
            ...
            dataArray.add(20L); //vàng nhận khi tạo nhân vật
            dataArray.add(0); //ngọc xanh nhận khi tạo nhân vật
            dataArray.add(0); //hồng ngọc nhận khi tạo nhân vật
            ...
            dataArray.add(1); //level cây đậu thần
