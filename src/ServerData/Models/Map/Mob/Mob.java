...
public class Mob {
    ...
    public List<ItemMap> getItemMobReward(Player player, int x, int yEnd) {
        ...
        for (Player pl : player.zone.getPlayers()) {
            ...
            if (MapService.gI().isMapUpTN(this.zone.map.mapId) && nPlSameClan >= 1
        ...
        // list.add(new ItemMap(Util.muahe(zone, Util.nextInt(695, 698), 1, x,
        // this.location.y, player.id)));
        // } else if (Util.isTrue(5, 150)){
        // list.add(new ItemMap(Util.muahe(zone, 694, 1, x, this.location.y,
        // player.id)));
        // }
        // }
        // }
        ...
        // if (this.zone.map.mapId >= 0){
        // if (Util.isTrue(10, 100)){
        // list.add(new ItemMap(Util.muahe(zone, 669, 1, x, this.location.y,
        // player.id)));
        // } else if (Util.isTrue(20, 100)){
        // list.add(new ItemMap(Util.muahe(zone, 569, 1, x, this.location.y,
        // player.id)));
        // }
        // }
        // }
        ...
        // if (this.zone.map.mapId >= 0){
        // if (Util.isTrue(10, 100)){
        // list.add(new ItemMap(Util.muahe(zone, Util.nextInt(1339,1341), 1, x,
        // this.location.y, player.id)));
        // }
        // }
        // break;
        ...
        // if (Util.isTrue(10, 100)){
        // list.add(new ItemMap(Util.muahe(zone, Util.nextInt(1437,1441), 1, x,
        // this.location.y, player.id)));
        // } else if (Util.isTrue(5, 100)){
        // list.add(new ItemMap(Util.muahe(zone, Util.nextInt(1442,1444), 1, x,
        // this.location.y, player.id)));
        // }
        // }
        // }
        ...
        // if(bohoa.isNotNullItem() && bohoa.template.id == 954 || bohoa.isNotNullItem()
        // && bohoa.template.id == 955){
        // if (player.zone.map.mapId >= 0) {
        // if (Util.isTrue(10, 100)){
        // list.add(new ItemMap(Util.muahe(zone, 589, 1, x, this.location.y,
        // player.id)));
        // }
        // }
        // }
    ...
    private ItemMap dropItemTask(Player player) {
        ...
        switch (this.tempId) {
            ...
            if (TaskService.gI().getIdTask(player) == ConstTask.TASK_8_1 ) {
                int[] NRs = new int[] { 20, 17, 18 };
                int randomNR = new Random().nextInt(NRs.length);
                if (Util.isTrue(100, 100)) {
                    if(randomNR == 0){
                        Service.gI().sendThongBao(player, "Chúc mừng bạn đã tìm thấy viên ngọc rồng 7 sao, nào bây giờ hãy đem nó về và báo cáo");
                    }
                    Service.gI().dropItemMap(this.zone, new ItemMap(zone, NRs[randomNR], 1, this.location.x, zone.map.yPhysicInTop(this.location.x, this.location.y - 24), player.id));
                }else
                {
                    Service.gI().sendThongBao(player, "Con này không giữ ngọc rồng, bạn hãy thử tìm con khác xem sao");
                }
            }
                break;
        }
