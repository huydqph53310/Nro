...
//        return 10000;
    ...
    public static int getRangeBom(int level, int mapWidth) { //phạm vi tự sát
        int rangeBom = (mapWidth / 7) * level;
        System.out.println("Giới hạn map " + mapWidth);
        System.out.println("phạm vi nổ " + rangeBom);
        return rangeBom;
    }

    public static int getRangeQCKK(int level, int mapWidth) { //phạm vi quả cầu kênh khi
        int rangeQC = (mapWidth / 7) * level;
        return rangeQC;
    }
