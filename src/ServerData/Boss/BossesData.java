...
public class BossesData {
    ...
    private static final int[][] FULL_SOCOLA = new int[][]{{Skill.SOCOLA, 1}, {Skill.SOCOLA, 2}, {Skill.SOCOLA, 3}, {Skill.SOCOLA, 4}, {Skill.SOCOLA, 5}, {Skill.SOCOLA, 6}, {Skill.SOCOLA, 7}};
    ...
    public static final BossData SO_4 = new BossData(
            ...
            new int[]{81,82,83,84}, //map join
            //           new int[]{86}, //map join
            new int[][]{
                {Skill.LIEN_HOAN, 7, 1000},
                {Skill.MASENKO, 7, 1000},
                {Skill.KAMEJOKO, 7, 700},{Skill.BIEN_KHI, 7, 100000}},//skill
    ...
    public static final BossData SO_3 = new BossData(
        ...
        new long[]{3_000_000}, //hp
        new int[]{81,82,83,84}, //map join
        (int[][]) Util.addArray(FULL_ANTOMIC, FULL_GALICK, FULL_MASENKO), 
        new String[]{}, //text chat 1
        new String[]{"|-1|Oải rồi hả?", "|-1|Ê cố lên nhóc",
            "|-1|Chán", "|-1|Đại ca Fide có nhầm không nhỉ",
    ...
    public static final BossData SO_1 = new BossData(
            ...
            new String[]{"|-1|Tiểu đội trưởng hãy trả thù cho ta"
            }, //text chat 3
            TypeAppear.APPEAR_WITH_ANOTHER //type appear
    );
    ...
    public static final BossData TIEU_DOI_TRUONG = new BossData(
            ...
            new int[]{81,82,83,84}, //map join
            (int[][]) Util.addArray(FULL_ANTOMIC, FULL_GALICK, FULL_MASENKO, FULL_SOCOLA), 
            new String[]{}, //text chat 1
            new String[]{"|-1|Oải rồi hả?", "|-1|Ê cố lên nhóc",
                "|-1|Chán", "|-1|Đại ca Fide có nhầm không nhỉ",
                "|-1|Một mình tao chấp hết tụi bây",
    ...
    public static final BossData DR_KORE = new BossData(
            ...
            new String[]{"|-1|Oải rồi hả?",
                ...
                "|-2|Lão già khôn thật!!",
                "|7|Hừ! Lão già khốn kiếp!",}, //text chat 2
    ...
    public static final BossData ANDROID_15 = new BossData(
            ...
            new String[]{}, //text chat 1
            new String[]{}, //text chat 2
            new String[]{"|7|Thì ra vẫn chỉ là một đống sắt vụn!"}, //text chat 3
            REST_10_M,
            new int[]{BossID.ANDROID_14,BossID.ANDROID_13} 
    );
//**************************************************************************
