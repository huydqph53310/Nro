...
import ServerData.Boss.ListBoss.NHIEMVU.AndroidSaga_ADR_NV;
...
import ServerData.Boss.ListBoss.NHIEMVU.FideSaga_TDST_SO1;
import ServerData.Boss.ListBoss.NHIEMVU.FideSaga_TDST_SO2;
import ServerData.Boss.ListBoss.NHIEMVU.FideSaga_TDST_SO3;
import ServerData.Boss.ListBoss.NHIEMVU.FideSaga_TDST_SO4;
import ServerData.Boss.ListBoss.NHIEMVU.FideSaga_TDST_TDT;
    ...
    public Boss createBoss(int bossID) {
        try {
            if (bossID <= BossID.BROLY_THUONG + 5 && bossID >= BossID.BROLY_THUONG) {
                ...
                return new Broly(MapService.gI().getZone(Util.randomMapBossBroly()), Util.nextInt(10000, 500000),
                        10000);
            }
            switch (bossID) {
                ...
                case BossID.MABU:
                    return new Mabu();
                case BossID.SO_4:
                    return new FideSaga_TDST_SO4();
                case BossID.SO_3:
                    return new FideSaga_TDST_SO3();
                case BossID.SO_2:
                    return new FideSaga_TDST_SO2();
                case BossID.SO_1:
                    return new FideSaga_TDST_SO1();
                case BossID.TIEU_DOI_TRUONG:
                    return new FideSaga_TDST_TDT();
