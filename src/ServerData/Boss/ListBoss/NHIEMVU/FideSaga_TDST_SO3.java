...
public class FideSaga_TDST_SO3 extends Boss {

    public FideSaga_TDST_SO3() throws Exception {
        super(BossID.SO_3, BossesData.SO_3);
    }

    public static boolean So3 = false;

    public static void GoiSo3(int a) {
        if (a == 1) {
            So3 = true;
        }
    }
