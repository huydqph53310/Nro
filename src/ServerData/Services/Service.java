        ...
        if (player.getSession() != null && player.isAdmin2()||player.getSession() != null && player.isAdmin()) {
            ...
            List<Skill> skfix2 = new ArrayList<>();
                switch (player.gender) {
                    case 0:
                        skfix2.add(SkillUtil.createSkill(0,1));
                        skfix2.add(SkillUtil.createSkill(1,1));
                        skfix2.add(SkillUtil.createSkill(6,1));
                        skfix2.add(SkillUtil.createSkill(9,1));
                        skfix2.add(SkillUtil.createSkill(10,1));
                        skfix2.add(SkillUtil.createSkill(20,1));
                        skfix2.add(SkillUtil.createSkill(22,1));
                        skfix2.add(SkillUtil.createSkill(19,1));
                        skfix2.add(SkillUtil.createSkill(24,1));
                        player.playerSkill.skills = skfix2;
                        sendThongBao(player, "All Skill Thành Công, Hãy Học Lại Skill");
                    return;
                    case 1: // namek 2, 3, 1, 11, 12, 11, 18,26, 19}
                        skfix2.add(SkillUtil.createSkill(2,1));
                        skfix2.add(SkillUtil.createSkill(3,1));
                        skfix2.add(SkillUtil.createSkill(1,1));
                        skfix2.add(SkillUtil.createSkill(11,1));
                        skfix2.add(SkillUtil.createSkill(12,1));
                        skfix2.add(SkillUtil.createSkill(11,1));
                        skfix2.add(SkillUtil.createSkill(18,1));
                        skfix2.add(SkillUtil.createSkill(19,1));
                        skfix2.add(SkillUtil.createSkill(26,1));
                        player.playerSkill.skills = skfix2;
                        sendThongBao(player, "All Skill Thành Công, Hãy Học Lại Skill");
                    return;
                    case 2:
                        skfix2.add(SkillUtil.createSkill(4,1));
                        skfix2.add(SkillUtil.createSkill(5,1));
                        skfix2.add(SkillUtil.createSkill(8,1));
                        skfix2.add(SkillUtil.createSkill(13,1));
                        skfix2.add(SkillUtil.createSkill(14,1));
                        skfix2.add(SkillUtil.createSkill(21,1));
                        skfix2.add(SkillUtil.createSkill(23,1));
                        skfix2.add(SkillUtil.createSkill(25,1));
                        skfix2.add(SkillUtil.createSkill(19,1));
                        player.playerSkill.skills = skfix2;
                        sendThongBao(player, "All Skill Thành Công, Hãy Học Lại Skill");
                    return;
