        ...
        switch (npc.tempId) {
            ...
            case ConstNpc.ONG_PARAGUS:
                return (doneTask(player, ConstTask.TASK_0_2)
                        ...
                        || doneTask(player, ConstTask.TASK_7_4)
            ...
            case ConstNpc.APPULE:
                return doneTask(player, ConstTask.TASK_7_3);
            case ConstNpc.DR_DRIEF:
            case ConstNpc.CARGO:
            case ConstNpc.CUI:
                return (doneTask(player, ConstTask.TASK_5_1) || doneTask(player, ConstTask.TASK_7_2)
            ...
            switch (idTaskCustom) {
                ...
                case ConstTask.TASK_0_3:
                    Service.gI().sendThongBao(player,
                            "Chúc mừng bạn đã hoàn thành nhiệm vụ" + player.playerTask.taskMain.subTasks.get(0).name
                                    + "về báo cáo với Ông " + transformName(player, "%2"));
                    break;
                ...
                case ConstTask.TASK_2_0:
                    if (isCurrentTask(player, idTaskCustom)) {
                        ...
                        System.out.println(player.playerTask.taskMain.subTasks.get(0).name);
                        Service.gI().sendThongBao(player, "Chúc mừng bạn đã hoàn thành nhiệm vụ, "
                                + player.playerTask.taskMain.subTasks.get(0).name + ". Nào, bây giờ bạn có thể gặp "
                                + transformName(player, "%2") + " để báo cáo rồi");
                    }
                    break;
                ...
                case ConstTask.TASK_3_0:
                    Service.gI().sendThongBao(player, "Hãy di chuyển đến chỗ có phi thuyền rớt xuống nào");
                    break;
                case ConstTask.TASK_3_1:
                    Service.gI().sendThongBao(player,
                            "Chúc mừng bạn đã hoàn thành nhiệm vụ, " + player.playerTask.taskMain.subTasks.get(1).name
                                    + ". Nào, bây giờ bạn có thể gặp " + transformName(player, "%2")
                                    + " để báo cáo rồi");
                    break;
                ...
                case ConstTask.TASK_4_0:
                    if (isCurrentTask(player, ConstTask.TASK_4_0)) {
                        Service.gI().sendThongBao(player, "Bạn đánh được "
                                + player.playerTask.taskMain.subTasks.get(player.playerTask.taskMain.index).count + "/"
                                + player.playerTask.taskMain.subTasks.get(player.playerTask.taskMain.index).maxCount
                ...
                case ConstTask.TASK_4_1:
                    if (isCurrentTask(player, ConstTask.TASK_4_1)) {
                        Service.gI().sendThongBao(player, "Bạn đánh được "
                                + player.playerTask.taskMain.subTasks.get(player.playerTask.taskMain.index).count + "/"
                                + player.playerTask.taskMain.subTasks.get(player.playerTask.taskMain.index).maxCount
                ...
                case ConstTask.TASK_4_2:
                    if (isCurrentTask(player, ConstTask.TASK_4_2)) {
                        Service.gI().sendThongBao(player, "Bạn đánh được "
                                + player.playerTask.taskMain.subTasks.get(player.playerTask.taskMain.index).count + "/"
                                + player.playerTask.taskMain.subTasks.get(player.playerTask.taskMain.index).maxCount
                        ...
                        Service.gI().sendThongBao(player,
                                "Chúc mừng bạn đã hoàn thành nhiệm vụ" + player.playerTask.taskMain.subTasks.get(0).name
                                        + "về báo cáo với " + transformName(player, "%2"));
                    }
                    break;
                ...
                case ConstTask.TASK_6_0:
                    Service.gI().sendThongBao(player, "Báo cáo với " + transformName(player, "%2") + " nào");
                    break;
                case ConstTask.TASK_6_1:
                    npcSay(player, ConstTask.NPC_NHA,
                            "Cháu gặp bạn " + transformName(player, "%7") + " rồi hả\n"
                                    + "Hãy giúp cậu ấy tiêu diệt lũ quái bay nhé\n"
                                    + "Đi đi con...");
                    break;
                // --------------------------------------------------------------
                case ConstTask.TASK_7_0:
                    Service.gI().sendThongBao(player, "Lên đường tìm kiếm lũ " + transformName(player, "%9") + " nào");
                    break;
                case ConstTask.TASK_7_1:
                    if (isCurrentTask(player, idTaskCustom)) {
                        ...
                        Service.gI().sendThongBao(player,
                                "Chúc mừng bạn đã hoàn thành nhiệm vụ" + player.playerTask.taskMain.subTasks.get(0).name
                                        + "về nói chuyện với " + transformName(player, "%8") + " ở làng "
                                        + transformName(player, "%1"));
                    }
                    break;
                ...
                case ConstTask.TASK_8_1:
                  Service.gI().sendThongBao(player, "Bạn đã tìm thấy viên ngọc rồng 7 sao mang về đưa cho " + transformName(player, "%2") + " nào");
                    break;
                ...
                NpcService.gI().createTutorial(player, -1, "Bò Mộng ở đẳng kia bạn hãy đến hỏi thăm anh ấy");
                    break;
                // --------------------------------------------------------------
                ...
                case ConstTask.TASK_11_3:
                    Item skill3 = ItemService.gI()
                            .createNewItem((short) (player.gender == 0 ? 94 : player.gender == 1 ? 101 : 108), 1);
                    InventoryServiceNew.gI().addItemBag(player, skill3);
                    npcSay(player, ConstTask.NPC_QUY_LAO,
                            "Tốt lắm, bây giờ con đã chính thức trở thành đệ tử của ta\n"
                                    + "Ta sẽ dạy con 1 tuyệt chiêu đặc biệt của ta\n"
                                    + "Bây giờ con hãy đi kết bạn với những người xung quanh đây đi, thêm 1 người bạn bớt 1 kẻ thù mà con\n"
    ...
    private String transformName(Player player, String text) {
        ...
        text = text.replaceAll(ConstTask.TEN_NPC_SHOP_LANG, player.gender == ConstPlayer.TRAI_DAT
                ...
                : (player.gender == ConstPlayer.NAMEC
                        ? "Dende"
                        : "Appule"));
        text = text.replaceAll(ConstTask.TEN_MAP_1000, player.gender == ConstPlayer.TRAI_DAT
                ? "Rừng Xương"
                : (player.gender == ConstPlayer.NAMEC
                        ? "Vực Maima"
                        : "Rừng thông xayda"));
